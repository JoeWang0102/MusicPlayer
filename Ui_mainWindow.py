...
# Form implementation generated from reading ui file 'c:\Users\Fort-Server3\Desktop\Joe\player\mainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(382, 650)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.hSlider_time = QtWidgets.QSlider(self.centralwidget)
        self.hSlider_time.setGeometry(QtCore.QRect(30, 110, 331, 22))
        ...
        self.pushBtn_nextSong.setGeometry(QtCore.QRect(180, 132, 60, 23))
        self.pushBtn_nextSong.setObjectName("pushBtn_nextSong")
        self.pushBtn_musicControl = QtWidgets.QPushButton(self.centralwidget)
        self.pushBtn_musicControl.setGeometry(QtCore.QRect(110, 132, 60, 23))
        ...
        self.pushBtn_previousSong.setGeometry(QtCore.QRect(40, 132, 60, 23))
        self.pushBtn_previousSong.setObjectName("pushBtn_previousSong")
        self.label_currentTime = QtWidgets.QLabel(self.centralwidget)
        self.label_currentTime.setGeometry(QtCore.QRect(199, 132, 80, 20))
